          ...
          <div>
            {tasks.length === 0 ? (
              ...
              <div className='w-[600px] h-[300px] flex items-center justify-center gap-4'>
                ...
                <Link to="/tasks/add" className="bg-black text-white hover:bg-black-600 font-medium rounded-md px-4 py-2">+ Add new task </Link>
              </div>
              ...
              tasks.map((task, index) => (
                <div key={task._id} className='bg-white my-4 p-4 text-gray-600 rounded-md shadow-md'>
                  ...
                  <div className='whitespace-pre'>{task.taskName}</div>
                  <div className='whitespace-pre'>{task.description}</div>
                  <div className='whitespace-pre'>{task.Status}</div>
                  <div className='whitespace-pre'>{task.Date}</div>
                </div>
              ))
