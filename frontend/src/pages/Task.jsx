          ...
          {loading ? (
            ...
            <>
              ...
              <div className="mb-4">
                ...
                <input type="taskName" name="taskName" id="taskName" value={formData.taskName} placeholder="Write here.." onChange={handleChange} />
                {fieldError("taskName")}
              </div>
              <div className="mb-4">
              ...
              <div className="mb-4">
                ...
                <input type="Status" name="Status" id="Status" value={formData.Status} placeholder="Write here.." onChange={handleChange} />
                {fieldError("Status")}
              </div>
             
              <button className='bg-black text-white px-4 py-2 font-medium hover:bg-primary-dark' onClick={handleSubmit}>{mode === "add" ? "Add task" : "Update Task"}</button>
